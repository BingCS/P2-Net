...
modes = ['test', 'train']
src_scene_path = root + 'RGBDScenesV2'
split_data_path = root + 'RGBDScenesV2'
p2net_path = root + 'RGBDScenesV2'

train_test_seq = {
    'rgbd-scenes-v2-scene_01': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_02': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_03': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_04': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_05': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_06': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_07': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_08': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_09': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_10': {'train': ['seq-01'], 'test': []},
    'rgbd-scenes-v2-scene_11': {'train': [], 'test': ['seq-01']},
    'rgbd-scenes-v2-scene_12': {'train': [], 'test': ['seq-01']},
    'rgbd-scenes-v2-scene_13': {'train': [], 'test': ['seq-01']},
    'rgbd-scenes-v2-scene_14': {'train': [], 'test': ['seq-01']}
}

corrs_train = {}
corrs_train_filename = os.path.join(p2net_path, f'RGBDScenesV2_train_0.010_corrs_7scenes.pkl')

pairs_train = {}
pairs_train_filename = os.path.join(p2net_path, f'RGBDScenesV2_train_0.030_pairs_7scenes.pkl')

corrs_test = {}
corrs_test_filename = os.path.join(p2net_path, f'RGBDScenesV2_test_0.010_corrs_7scenes.pkl')

pairs_test = {}
pairs_test_filename = os.path.join(p2net_path, f'RGBDScenesV2_test_0.030_pairs_7scenes.pkl')
skip = 5

loop_list = np.arange(0, 5)
scene_list = sorted(os.listdir(src_scene_path))
for scene in scene_list[0:]:
    if scene == 'rgbd-scenes-v2-scene_01':
        frame_len = 34
    elif scene == 'rgbd-scenes-v2-scene_02':
        frame_len = 29
    elif scene == 'rgbd-scenes-v2-scene_03':
        frame_len = 29
    elif scene == 'rgbd-scenes-v2-scene_04':
        frame_len = 29
    elif scene == 'rgbd-scenes-v2-scene_05':
        frame_len = 44
    elif scene == 'rgbd-scenes-v2-scene_06':
        frame_len = 39
    elif scene == 'rgbd-scenes-v2-scene_07':
        frame_len = 34
    elif scene == 'rgbd-scenes-v2-scene_08':
        frame_len = 34
    elif scene == 'rgbd-scenes-v2-scene_09':
        frame_len = 24
    elif scene == 'rgbd-scenes-v2-scene_10':
        frame_len = 24
    elif scene == 'rgbd-scenes-v2-scene_11':
        frame_len = 24
    elif scene == 'rgbd-scenes-v2-scene_12':
        frame_len = 24
    elif scene == 'rgbd-scenes-v2-scene_13':
        frame_len = 14
    elif scene == 'rgbd-scenes-v2-scene_14':
        frame_len = 24
