...
# root = '/Volumes/Bing_S/'
root = '/home/hdd/Downloads/shiyan/'
modes = ['test', 'train']
src_scene_path = root + '3dmatch'
split_data_path = root + '3dmatch'
p2net_path = root + '3dmatch'

train_test_seq = {
    '1': {'train': ['seq-01','seq-02','seq-03','seq-04','seq-05','seq-06'], 'test': []},
    '2': {'train': ['seq-01','seq-02','seq-03','seq-04'], 'test': []},
    '3': {'train': ['seq-01','seq-02'], 'test': []},
    '4': {'train': ['seq-01','seq-02','seq-03','seq-04','seq-05','seq-06','seq-07','seq-08','seq-09','seq-10'], 'test': []},
    '5': {'train': ['seq-01','seq-02','seq-03','seq-06','seq-07','seq-08'], 'test': []},
    '6': {'train': ['seq-01','seq-02','seq-03','seq-04','seq-05','seq-06'], 'test': []},
    '15': {'train': ['seq-01'], 'test': []},
    '16': {'train': ['seq-01'], 'test': []},
    '17': {'train': ['seq-01'], 'test': []},
    '18': {'train': ['seq-01'], 'test': []},
    '19': {'train': ['seq-01'], 'test': []},
    '20': {'train': ['seq-01'], 'test': []},
    '21': {'train': ['seq-01'], 'test': []},
    '22': {'train': ['seq-01'], 'test': []},
    '23': {'train': ['seq-01'], 'test': []},
    '24': {'train': ['seq-01'], 'test': []},
    '25': {'train': ['seq-01'], 'test': []},
    '26': {'train': ['seq-01'], 'test': []},
    '27': {'train': ['seq-01'], 'test': []},
    '28': {'train': ['seq-01'], 'test': []},
    '29': {'train': ['seq-01'], 'test': []},
    '30': {'train': ['seq-01'], 'test': []},
    '31': {'train': ['seq-01'], 'test': []},
    '32': {'train': ['seq-01'], 'test': []},
    '33': {'train': ['seq-01'], 'test': []},
    '34': {'train': ['seq-01'], 'test': []},
    '35': {'train': ['seq-01'], 'test': []},
    '36': {'train': ['seq-01'], 'test': []},
    '38': {'train': ['seq-01'], 'test': []},
    '39': {'train': ['seq-01'], 'test': []},
    '40': {'train': ['seq-01'], 'test': []},
    '41': {'train': ['seq-01'], 'test': []},
    '42': {'train': ['seq-01'], 'test': []},
    '43': {'train': ['seq-01'], 'test': []},
    '44': {'train': ['seq-01'], 'test': []},
    '45': {'train': ['seq-01'], 'test': []},
    '46': {'train': ['seq-01'], 'test': []},
    '47': {'train': ['seq-01'], 'test': []},
    '48': {'train': ['seq-01'], 'test': []},
    '49': {'train': ['seq-01'], 'test': []},
    '50': {'train': ['seq-01'], 'test': []},
    '51': {'train': ['seq-01'], 'test': []},
    '52': {'train': ['seq-01'], 'test': []},
    '53': {'train': ['seq-01'], 'test': []},
    '54': {'train': ['seq-01'], 'test': []},
    '55': {'train': ['seq-01'], 'test': []},
    '56': {'train': [], 'test': ['seq-01']},
    '57': {'train': [], 'test': ['seq-01']},
    '58': {'train': [], 'test': ['seq-01']},
    '59': {'train': [], 'test': ['seq-01']},
    '60': {'train': [], 'test': ['seq-01']},
    '61': {'train': [], 'test': ['seq-01']},
}

corrs_train = {}
corrs_train_filename = os.path.join(p2net_path, f'3dmatch_train_0.010_corrs_7scenes.pkl')

pairs_train = {}
pairs_train_filename = os.path.join(p2net_path, f'3dmatch_train_0.030_pairs_7scenes.pkl')

corrs_test = {}
corrs_test_filename = os.path.join(p2net_path, f'3dmatch_test_0.010_corrs_7scenes.pkl')

pairs_test = {}
pairs_test_filename = os.path.join(p2net_path, f'3dmatch_test_0.030_pairs_7scenes.pkl')
skip = 5
